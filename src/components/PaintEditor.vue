...
import {
  VpEditor, useAllTools, useBackground, useFreehand, useRectangle, downloadSvg, createSettings, type ImageHistory,
  urlToBlob, exportPng
} from 'vue-paint'
...
const bg = useBackground({ blob: urlToBlob(props.background), color: undefined })
// Add the tools you like to use, or call useAllTools to make use of all available tools
const tools = [useFreehand(), bg]
